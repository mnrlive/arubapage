...
export const aweMainta = `${proxy}https://www.awemainta.com/index.php?rest_route=/wp/v2/posts&per_page=${articleCount}`;
...
const services = {
    arubaNative,noticiaCla,eArubianoNews,aweMainta,_24ora,boletinExtra,masNoticia,awe24,diario,focus,batiBleki,bonDia,sports,solo,xclusivo
}
