...
export const arubaToday = `${proxy}https://www.arubatoday.com/wp-json/wp/v2/posts?_embed&per_page=${articleCount}`;
...
const services = {
    arubaNative,noticiaCla,eArubianoNews,_24ora,masNoticia,aweMainta,diario,focus,batiBleki,bonDia,sports,solo,xclusivo, awe24, arubaToday
